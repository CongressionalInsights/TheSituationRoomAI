export function initPanelScroll({ state, helpers }) {
  ...
  const configs = [
    ...
    { id: 'policyList', getItems: () => (getFederalPolicyItems ? getFederalPolicyItems() : getCategoryItems('gov').items) },
    { id: 'stateGovAllList', getItems: () => (getStateGovernmentItems ? getStateGovernmentItems() : []) },
    { id: 'stateGovLegislationList', getItems: () => (getStateGovernmentItems ? getStateGovernmentItems('legislation') : []) },
    { id: 'stateGovRulemakingList', getItems: () => (getStateGovernmentItems ? getStateGovernmentItems('rulemaking') : []) },
    { id: 'stateGovExecutiveOrdersList', getItems: () => (getStateGovernmentItems ? getStateGovernmentItems('executive_order') : []) },
