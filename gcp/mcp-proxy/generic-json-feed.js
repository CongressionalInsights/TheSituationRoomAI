...
function getGenericJsonList(data) {
  ...
  if (Array.isArray(data?.amendments)) return data.amendments;
  if (Array.isArray(data?.committeeReports)) return data.committeeReports;
  if (Array.isArray(data?.committeeReport)) return data.committeeReport;
  if (Array.isArray(data?.reports)) return data.reports;
  if (Array.isArray(data?.houseRollCallVotes)) return data.houseRollCallVotes;
  if (Array.isArray(data?.events)) return data.events;
  if (Array.isArray(data?.hearings)) return data.hearings;
  if (Array.isArray(data?.nominations)) return data.nominations;
  if (Array.isArray(data?.treaties)) return data.treaties;
  if (Array.isArray(data?.congressionalRecord)) return data.congressionalRecord;
...
export function parseGenericJsonFeed(data, feed) {
  ...
  const list = getGenericJsonList(data);
